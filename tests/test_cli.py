"""Smoke tests for the amazing-hand-cli CLI entry point and its verbs."""
...
from amazing_hand.explain import known_paths
...
def test_whoami_text(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert "nick: amazing-hand-cli" in out
...
def test_whoami_json(capsys: pytest.CaptureFixture[str]) -> None:
    ...
    assert payload["nick"] == "amazing-hand-cli"
