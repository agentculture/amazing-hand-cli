"""``amazing-hand-cli overview`` — read-only descriptive snapshot of the agent.
...
:mod:`amazing_hand.cli._commands.cli`).
...
from amazing_hand.cli._commands.whoami import report
