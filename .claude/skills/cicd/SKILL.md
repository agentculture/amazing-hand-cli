...
type: command
description: >
  amazing-hand-cli's CI/CD lane, layered on `devex pr`. Delegates lint / open /
  ...
  unresolved threads). Use when: creating PRs in amazing-hand-cli, handling
...
# CI/CD — amazing-hand-cli edition
